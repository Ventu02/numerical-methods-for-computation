...
figure(1);
subplot(2,2,1) %in alto a sinistra: grafico del polinomio interpolante e della funzione su punti equispaziati
hold on;
...
%in basso a sinistra: errore su punti equispaziati
...
%lato sinistro: con polinomi di chebychev
subplot(2,2,2)
hold on;
%grafico funzione test
plot(xv,yf,'r-','LineWidth',2);
