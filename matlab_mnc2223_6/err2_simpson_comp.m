...
% Es. a
%*******************************************************
% Calcola integrale con formula di Simpson composta per passi h dimezzati
...
for i=1:m % ciclo per m iterazioni
    ...
    IA=simpson_comp(funz,a,b,n,0); % calcolo dell'integrale approssimato con Simpson composta
